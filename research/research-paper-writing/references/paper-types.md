...
Workshop papers and short papers (e.g., ACL short papers, Findings papers) follow the same overall pipeline as a full empirical paper but with different constraints and expectations.
...
| **arXiv** | Post anytime | Timing matters (see arXiv strategy in [submission-mechanics.md](submission-mechanics.md)) |
