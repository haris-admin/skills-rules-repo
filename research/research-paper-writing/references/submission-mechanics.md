# Submission Mechanics: Anonymization, Compilation, Conversion, Camera-Ready, arXiv, Code Release

Detailed procedures for Phase 7 (Submission Preparation) beyond the conference paper checklists (see [checklists.md](checklists.md)). Load this when actually preparing a submission package, converting between venues, or releasing code.
...
- [Camera-Ready Preparation (Post-Acceptance)](#camera-ready-preparation-post-acceptance)
