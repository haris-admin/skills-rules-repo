...
This skill is designed for the Hermes agent. It uses Hermes tools, delegation, scheduling, and memory for the full research lifecycle. Load this reference when running under Hermes and you need the specific tool-call patterns, state-management conventions, or cron/communication protocols below.
