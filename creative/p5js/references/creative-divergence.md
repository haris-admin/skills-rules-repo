...
Use only when the user requests creative, experimental, surprising, or
unconventional output. Select the strategy that best fits and reason
through its steps BEFORE generating code.
