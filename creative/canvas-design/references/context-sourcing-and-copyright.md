...
Rules for recreating/extending an existing UI from a repo, reading non-HTML source documents, and staying clear of copyright issues when working from reference models.
