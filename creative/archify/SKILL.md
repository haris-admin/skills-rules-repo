...
version: "2.17.0"
author: tt-a1i (github.com/tt-a1i/archify), vendored by Haris Habib
license: MIT
dependencies: [node>=18]
platforms: [linux, macos, windows]
metadata:
  based_on: Cocoon-AI/architecture-diagram-generator (MIT, v1.0)
  vendored_from: https://github.com/tt-a1i/archify (archify/ subdirectory)
  vendored_date: 2026-09-17
  hermes:
    tags: [architecture, diagrams, dataflow, workflow, sequence, lifecycle, SVG, HTML, visualization, mermaid]
    related_skills: [architecture-diagram, excalidraw, html-mockup]
---
