...
### Investigate-First PR (approval-gated)

Some teams require root cause analysis **before** writing any fix code.

See `references/investigate-first-pr.md` — Two-phase workflow: investigate → present findings → get approval → fix → PR. Includes WSL git troubleshooting (corrupted remote URLs, credential discovery, pre-push hooks).

### Programmatic PR Creation via Python API
