...
- [Testing](#testing)
- [Extending the system prompt's execution-environment block](#extending-the-system-prompts-execution-environment-block)
- [Commit Conventions](#commit-conventions)
- [Key Rules](#key-rules)
- [Authoring in-repo skills](#authoring-in-repo-skills)
...
For writing or updating a bundled SKILL.md inside this repo (as opposed to a
hub-installed skill) — where it lives, how discovery differs from installed
skills, and the authoring conventions to follow — see
[Authoring In-Repo Skills](in-repo-skill-authoring.md).
