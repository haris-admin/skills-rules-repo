...
- Rules: see the testing guidelines in this skill and the react-patterns skill for component boundaries
- Skills: [react-patterns](../react-patterns/SKILL.md), [accessibility](../accessibility/SKILL.md), [e2e-testing](../e2e-testing/SKILL.md); tdd-workflow ships as a sibling skill in the full pack
