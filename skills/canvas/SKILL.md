---
name: canvas
description: Display HTML content, games, interactive visualizations, and dashboards on connected OpenClaw nodes (Mac app, iOS, Android). Use when presenting web content on a canvas view or testing live-reload web apps.
---
