...
| **[amlhive-blog-linkedin-push](./content-growth-and-media/amlhive-blog-linkedin-push/SKILL.md)** | Turn one AMLHive compliance-blog article into a full social push: an AMLHive company-page post, a founder personal post, an X post, a disclosed… | - |
...
| **[au-vc-funding-radar](./research/au-vc-funding-radar/SKILL.md)** | "Use when producing the weekly AU/ANZ VC funding radar." | [Sources And Benchmarks](./research/au-vc-funding-radar/references/sources-and-benchmarks.md) |
...
| **[aws-fleet-patching](./devops/aws-fleet-patching/SKILL.md)** | Use when patching the AWS EC2 fleet via SSM. | - |
...
| **[ce-babysit-pr](./compound-engineering/ce-babysit-pr/SKILL.md)** | "Babysits an open GitHub PR until merge-ready. Use when asked to watch a PR over time — not for one-shot comment resolution or one CI failure. GitHub… | [Branch Currency](./compound-engineering/ce-babysit-pr/references/branch-currency.md) |
| **[ce-bakeoff](./compound-engineering/ce-bakeoff/SKILL.md)** | "Develop independent competing solutions to a defined brief, compare them, and synthesize a winning approach. Use when choosing well requires… | [Candidates](./compound-engineering/ce-bakeoff/references/candidates.md) |
| **[ce-brainstorm](./compound-engineering/ce-brainstorm/SKILL.md)** | "Explore vague or ambitious ideas into a right-sized requirements-only unified plan. Use when the user wants to brainstorm or scope what to build… | [Approaches](./compound-engineering/ce-brainstorm/references/approaches.md) |
| **[ce-code-review](./compound-engineering/ce-code-review/SKILL.md)** | "Review a named diff or PR for bugs, regressions, tests, and standards. Use when asked to review code or when a shipping skill needs a review… | [Action Class Rubric](./compound-engineering/ce-code-review/references/action-class-rubric.md) |
| **[ce-commit](./compound-engineering/ce-commit/SKILL.md)** | Create a git commit with a clear, value-communicating message. Use when the user asks to commit/save staged or unstaged changes with a… | - |
| **[ce-commit-push-pr](./compound-engineering/ce-commit-push-pr/SKILL.md)** | Commit, push, and open a PR. Use when asked to ship/open a PR, or for PR-description-only flows like writing, rewriting, or describing a PR body. | [Apply And Handoff](./compound-engineering/ce-commit-push-pr/references/apply-and-handoff.md) |
| **[ce-compound](./compound-engineering/ce-compound/SKILL.md)** | Document a solved problem as a durable repo learning. Use when verified work produced non-obvious reasoning absent from its final code, tests, or… | [Assembly](./compound-engineering/ce-compound/references/assembly.md) |
| **[ce-compound-refresh](./compound-engineering/ce-compound-refresh/SKILL.md)** | Refresh the repo's captured learnings against the current codebase. Use when auditing stale, overlapping, superseded, or drifted learnings; avoid… | [Classify](./compound-engineering/ce-compound-refresh/references/classify.md) |
| **[ce-debug](./compound-engineering/ce-debug/SKILL.md)** | "Diagnosis loop for bugs and failing behavior. Use when asked to debug or fix failing or slow behavior." | [Anti Patterns](./compound-engineering/ce-debug/references/anti-patterns.md) |
| **[ce-doc-review](./compound-engineering/ce-doc-review/SKILL.md)** | Review requirements, plans, or specs with role-specific lenses. Use when the user wants to improve an existing planning document. | [Bulk Preview](./compound-engineering/ce-doc-review/references/bulk-preview.md) |
| **[ce-dogfood](./compound-engineering/ce-dogfood/SKILL.md)** | "Hands-off, diff-scoped browser QA of the active branch: maps user flows, drives a real browser, autonomously fixes small breakages with regression… | [Dogfood Report Template](./compound-engineering/ce-dogfood/references/dogfood-report-template.md) |
| **[ce-draft](./compound-engineering/ce-draft/SKILL.md)** | "Shortcut for ce-brainstorm: drafts a vague or ambitious idea into a requirements-only plan (the WHAT) that ce-plan can build on. Use when the user… | - |
| **[ce-execute](./compound-engineering/ce-execute/SKILL.md)** | "Shortcut for ce-work: executes a plan or concrete work prompt end to end with local verification. Use when the user says ce-execute, execute the… | - |
| **[ce-explain](./compound-engineering/ce-explain/SKILL.md)** | "Explain how and why something has its current shape, or what happened over a window of work, grounded in evidence. Use when the user asks for an… | [Check In](./compound-engineering/ce-explain/references/check-in.md) |
| **[ce-handoff](./compound-engineering/ce-handoff/SKILL.md)** | Create a session handoff for another agent, or resume, find, and read any user-selected continuity source. Use when work or conversation must… | [Create](./compound-engineering/ce-handoff/references/create.md) |
| **[ce-ideate](./compound-engineering/ce-ideate/SKILL.md)** | "Generate and evaluate grounded ideas. Use when the user wants ideas, improvements, or surprising directions before choosing one to develop. Not for… | [Decomposition](./compound-engineering/ce-ideate/references/decomposition.md) |
| **[ce-noslop](./compound-engineering/ce-noslop/SKILL.md)** | "Rewrite, check, or draft prose so it carries no AI writing tells, reads plainly on the first read, and keeps every source fact. Use when asked to… | [Patterns](./compound-engineering/ce-noslop/references/patterns.md) |
| **[ce-optimize](./compound-engineering/ce-optimize/SKILL.md)** | "Optimize a named target with a measured loop: attribute a workload's cost, or score variants and keep winners. Use when a working system's metric… | [Experiment Prompt Template](./compound-engineering/ce-optimize/references/experiment-prompt-template.md) |
| **[ce-plan](./compound-engineering/ce-plan/SKILL.md)** | "Create structured plans for multi-step work, including software and non-software tasks. Use when asked to plan, break down implementation, plan from… | [Approach Altitude](./compound-engineering/ce-plan/references/approach-altitude.md) |
| **[ce-polish](./compound-engineering/ce-polish/SKILL.md)** | "Polish a working feature through user-directed live browser feedback. Use when a functional feature needs focused UX refinement before shipping." | [Dev Server Astro](./compound-engineering/ce-polish/references/dev-server-astro.md) |
| **[ce-pov](./compound-engineering/ce-pov/SKILL.md)** | "Judge a supplied subject against the project's evidence and constraints. Use when assessing an external-adoption question, a holistic take on a… | [Boundaries](./compound-engineering/ce-pov/references/boundaries.md) |
| **[ce-product-pulse](./compound-engineering/ce-product-pulse/SKILL.md)** | "Generate time-windowed product pulse reports from configured signals." | [Config](./compound-engineering/ce-product-pulse/references/config.md) |
| **[ce-promote](./compound-engineering/ce-promote/SKILL.md)** | "Draft launch or promotion copy for a shipped feature." | [Spiral Cli](./compound-engineering/ce-promote/references/spiral-cli.md) |
| **[ce-proof](./compound-engineering/ce-proof/SKILL.md)** | Publish, read, comment on, or edit markdown in Proof. Use for Proof links, sharing specs/plans/drafts, or publish handoffs from planning workflows… | [Api](./compound-engineering/ce-proof/references/api.md) |
| **[ce-prototype](./compound-engineering/ce-prototype/SKILL.md)** | Build a throwaway prototype to answer how something should work, feel, or read. Use when committing the wrong answer would be expensive to unravel… | [Annotation Loop](./compound-engineering/ce-prototype/references/annotation-loop.md) |
| **[ce-resolve-pr-feedback](./compound-engineering/ce-resolve-pr-feedback/SKILL.md)** | Resolve PR review feedback. Use when addressing feedback already left on a PR. Not for reviewing the code before feedback exists; that is… | [Evaluation Rubric](./compound-engineering/ce-resolve-pr-feedback/references/evaluation-rubric.md) |
| **[ce-retune](./compound-engineering/ce-retune/SKILL.md)** | "Retune a skill corpus for a new model, measurement-first: mine the run archive for a baseline, establish a noise floor, audit the corpus… | [Baseline Mining](./compound-engineering/ce-retune/references/baseline-mining.md) |
| **[ce-riffrec-feedback-analysis](./compound-engineering/ce-riffrec-feedback-analysis/SKILL.md)** | "Analyze recorded product feedback into evidence for bugs and requirements. Use when a Riffrec capture or other screen, voice, or notes artifact… | [Analyzer](./compound-engineering/ce-riffrec-feedback-analysis/references/analyzer.md) |
| **[ce-setup](./compound-engineering/ce-setup/SKILL.md)** | "Check Compound Engineering health and repo-local config, or scaffold a Compound Pack with `pack:<id>`." | [Legacy Codex Tool Map](./compound-engineering/ce-setup/references/legacy-codex-tool-map.md) |
| **[ce-simplify-code](./compound-engineering/ce-simplify-code/SKILL.md)** | "Simplify settled, recently changed code for clarity, reuse, quality, and efficiency while preserving behavior. Use after implementation and before… | - |
| **[ce-strategy](./compound-engineering/ce-strategy/SKILL.md)** | "Create or update STRATEGY.md. Use when starting a product, adding a strategy doc, or changing direction or roadmap." | [Grounding](./compound-engineering/ce-strategy/references/grounding.md) |
| **[ce-sweep](./compound-engineering/ce-sweep/SKILL.md)** | "Sweep configured feedback sources (Slack, GitHub Issues; email experimental) for new items: acknowledge at source, analyze recordings, verify fixes… | [Interview](./compound-engineering/ce-sweep/references/interview.md) |
| **[ce-test-browser](./compound-engineering/ce-test-browser/SKILL.md)** | Run browser tests for pages affected by the current branch or PR. Use when asked to run or check browser tests for the current change. | [Agent Browser Driver](./compound-engineering/ce-test-browser/references/agent-browser-driver.md) |
| **[ce-test-xcode](./compound-engineering/ce-test-xcode/SKILL.md)** | "Test iOS apps in a simulator with XcodeBuildMCP. Use when iOS changes need simulator evidence before handoff." | [Setup And Build](./compound-engineering/ce-test-xcode/references/setup-and-build.md) |
| **[ce-work](./compound-engineering/ce-work/SKILL.md)** | Execute a plan or concrete work prompt end-to-end. Use when implementing from a plan document, a spec path, or a clear build request; use ce-debug… | [Cross Model Execution](./compound-engineering/ce-work/references/cross-model-execution.md) |
| **[ce-worktree](./compound-engineering/ce-worktree/SKILL.md)** | Set up isolated git worktrees — create a new branch for fresh work, or attach a worktree to an existing branch, PR, or commit. Use when starting… | - |
...
| **[lfg](./compound-engineering/lfg/SKILL.md)** | "Take a request all the way to done, hands-off, through the right Compound Engineering skills. A code change ends as an open pull request, pushed… | [Debug Return](./compound-engineering/lfg/references/debug-return.md) |
...
| **[wtf](./compound-engineering/wtf/SKILL.md)** | "Explain the last message, or a supplied file, link, or passage, in plain language a person follows on the first read. Use when the user invokes wtf… | - |
...
| **[Evals Use the Production Prompt, Imported](./rules/evals-use-the-production-prompt.md)** | An eval of an AI prompt must import the exact prompt text production sends from one shared module, never copy it and never extract it from source… |
...
| **[Runtime Files Must Survive the Build Ignore List](./rules/runtime-files-survive-build-ignore.md)** | Any file the server reads at runtime (rules, prompts, templates, data) must be in a format and path the production image actually copies, and a test… |
...
| **[Sentinel-value data repairs must audit every table that stores or joins on the column, not just the one the symptom touched](./rules/sentinel-value-repair-join-key-audit.md)** | A repair that clears a sentinel value (`'unknown'`, `NULL`, a placeholder ID) in one table but leaves it in a sibling table that joins on the same… |
...
| **[Third-Party Client-Side Tag Guarding](./rules/third-party-tag-guarding.md)** | Every third-party browser tag (analytics, ads, social pixels, session replay, bot management, tag managers) must carry five guards, and turning off a… |
