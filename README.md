...
| **[incremental-version-bumping](./skills/incremental-version-bumping/SKILL.md)** | Mandatory version bumping protocol across all agents (Claude Code, Antigravity, Cursor, Codex, Devin) starting with 0.10.0 baseline, defect fixes… | - |
